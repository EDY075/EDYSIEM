...
> **Status:** Sprint 1 (Foundation Core) concluída — tag `v0.1.0`. Sprints 2.1–2.6
> concluídas: pipeline oficial (ADR-008), infraestrutura de ingestão (ADR-009),
> parsers + normalizer, Enrichment Engine, Correlation Engine e Rule/Detection
> Framework (DSL declarativa) — frameworks desacoplados com regras declarativas,
> janelas temporais, isolamento de falhas e métricas.
